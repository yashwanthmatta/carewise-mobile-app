...
assert(packageJson.scripts?.["build:android:production"] === "eas build --platform android --profile production", "Android production build script is required.");
assert(packageJson.scripts?.["build:ios:production"] === "eas build --platform ios --profile production", "iOS production build script is required.");
assert(packageJson.scripts?.["submit:android:production"] === "eas submit --platform android --profile production", "Android production submit script is required.");
assert(packageJson.scripts?.["submit:ios:production"] === "eas submit --platform ios --profile production", "iOS production submit script is required.");
...
console.log("  npm run build:ios:production");
console.log("  npm run submit:android:production");
console.log("  npm run submit:ios:production");
